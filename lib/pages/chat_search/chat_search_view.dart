...
import 'package:yomi/pages/chat_search/chat_search_files_tab.dart';
import 'package:yomi/pages/chat_search/chat_search_images_tab.dart';
import 'package:yomi/pages/chat_search/chat_search_message_tab.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: MaxWidthBody(
        ...
        child: Column(
          children: [
            if (LyiThemes.isThreeColumnMode(context))
