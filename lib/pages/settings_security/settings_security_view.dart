...
import 'package:yomi/utils/beautify_string_extension.dart';
...
import 'package:yomi/widgets/settings_switch_list_tile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        automaticallyImplyLeading: !LyiThemes.isColumnMode(context),
        centerTitle: LyiThemes.isColumnMode(context),
      ),
      body: ListTileTheme(
