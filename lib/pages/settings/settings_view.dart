...
import 'package:yomi/widgets/navigation_rail.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: Scaffold(
            appBar: LyiThemes.isColumnMode(context)
                ? null
                : AppBar(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: () => PlatformInfos.showAboutAppDialog(context),
                  ),
                  Divider(color: theme.dividerColor),
                  ListTile(
