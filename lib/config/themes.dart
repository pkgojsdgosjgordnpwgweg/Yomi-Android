...
abstract class LyiThemes {
  ...
  static bool isThreeColumnMode(BuildContext context) =>
      MediaQuery.of(context).size.width > LyiThemes.columnWidth * 3.5;
  ...
  static ThemeData buildTheme(
    ...
    final isColumnMode = LyiThemes.isColumnMode(context);
    return ThemeData(
      ...
      snackBarTheme: isColumnMode
          ? const SnackBarThemeData(
              ...
              width: LyiThemes.columnWidth * 1.5,
            )
