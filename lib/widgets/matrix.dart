...
import 'package:yomi/utils/init_with_restore.dart';
import 'package:yomi/utils/matrix_sdk_extensions/matrix_file_extension.dart';
import 'package:yomi/utils/platform_infos.dart';
import 'package:yomi/utils/uia_request_manager.dart';
import 'package:yomi/utils/voip_plugin.dart';
...
class MatrixState extends State<Matrix> with WidgetsBindingObserver {
  ...
  String? get activeRoomId {
    final route = YomiApp.router.routeInformationProvider.value.uri.path;
  ...
  Future<void> dehydrateAction(BuildContext context) async {
    ...
    final exportFileName =
        'yomi-export-${DateFormat(DateFormat.YEAR_MONTH_DAY).format(DateTime.now())}.yomibackup';
